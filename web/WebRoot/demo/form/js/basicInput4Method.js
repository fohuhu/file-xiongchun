	...
	var firstForm = new Ext.form.FormPanel({
				...
				tbar : [{
							...
							handler : function() {
								...
								firstForm.findById('name2')
										.addClass('x-custom-field-disabled');
							}
						}, {
							text : '激活',
							iconCls : 'acceptIcon',
				...
				bbar : [{
							...
							handler : function() {
								...
								firstForm.findById('name2').getEl().up('.x-form-item').setDisplayed(false);
							}
						}, {
							text : '显示',
							handler : function() {
								firstForm.findById('name2').show();
								firstForm.findById('name2').getEl().up('.x-form-item').setDisplayed(true);
							}
						}, '-', {
							text : '赋值',
							handler : function() {
