...
function getWebRoot() {
	...
	for (var i = 0; i < nodes.length; ++i) {
		...
		if (src) {
			var index = src.indexOf("resource/pushlets/js-pushlet-client.js");
			if (index >= 0) {
...
function _initURIs() {
	pushletURI = getWebRoot() + 'pushlet.srv?userid=' + parent.userid;
	pushletNetURI = getWebRoot() + 'resource/pushlets/js-pushlet-net.html';
}
