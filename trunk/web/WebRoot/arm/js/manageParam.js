...
Ext
		.onReady(function() {
			...
			var grid = new Ext.grid.GridPanel({
				title : '<span style="font-weight:normal">全局参数表</span>',
				iconCls : 'configIcon',
			...
			var addParamWindow = new Ext.Window(
					{
						...
						draggable : true,
						closeAction : 'hide',
						title : '<span styel="font-weight:normal">新增全局参数</span>',
						modal : true,
						collapsible : true,
						titleCollapse : true,
						maximizable : false,
			...
			function addInit() {
				...
				addParamWindow.show();
				addParamWindow
						.setTitle('<span style="font-weight:normal">新增全局参数</span>');
			...
			function editInit() {
				...
				addParamWindow.show();
				addParamWindow
						.setTitle('<span style="font-weight:normal">修改全局参数</span>');
