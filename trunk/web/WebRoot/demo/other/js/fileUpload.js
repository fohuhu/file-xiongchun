...
Ext.onReady(function() {
	...
	var firstWindow = new Ext.Window({
		title : '<span style="font-weight:normal">上传[传统Web模式]</span>', // 窗口标题
		layout : 'fit', // 设置窗口布局模式
		width : 500, // 窗口宽度
		height : 200, // 窗口高度
		closable : true, // 是否可关闭
	...
	var win_swfupload = new Ext.Window({
		title : '<span style="font-weight:normal">上传[Flash组件模式]</span>',
		width : 500,
		height : 350,
		resizable : false,
		layout : 'fit',
	...
	function submitTheForm() {
		...
		var requesturl = 'otherDemo.ered?reqCode=doUpload';
		if(mode == 'ftp') {
		   requesturl = 'otherDemo.ered?reqCode=doUploadByFTP';
		}
